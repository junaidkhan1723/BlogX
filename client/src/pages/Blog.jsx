      ...
      <div className="relative px-5 max-w-5xl mx-auto my-10 mt-6">
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto ">
          ...
          {comments.length === 0 ? (
            ...
            {comments.map((item, index) => (
              <div
                key={index}
                className="relative bg-primary/4 border border-primary/10 max-w-xl p-4 rounded text-gray-600"
              >
        ...
        <div className="max-w-3xl max-auto mt-4">
          ...
          <form onSubmit={addComment} className=" flex flex-col items-start gap-4 max-w-lg">
            ...
            <textarea onChange={(e)=> setContent(e.target.value)} value={content} name="" id="" placeholder="Comment your Thoughts" className="w-full p-2 border border-gray-300 rounded outline-none h-48" required></textarea>
