...
function BlogX() {
  ...
  return (
    <>
      <div className="min-h-screen w-full relative bg-[#fefcff]">
        ...
        <div className="relative z-10">
          ...
          <div className="mx-8 sm:mx-16 xl:mx-24 pt-4 sm:pt-6 text-center">
            ...
            <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-700 text-center">
              Your{" "}
              <span className="font-semibold text-indigo-700">Creative Space</span>{" "}
              to
            ...
            <form
              ...
              className="flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-400 bg-white rounded overflow-hidden mb-4"
            >
              <input
                ref={inputRef}
                type="text"
